...
export default class HistoriaUsuario extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllHistoriaUsuarios();
  }
  ...
  public retrieveAllHistoriaUsuarios(): void {
  ...
  public prepareRemove(instance: IHistoriaUsuario): void {
  ...
  public removeHistoriaUsuario(): void {
    this.historiaUsuarioService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('jhipsterdemoApp.historiaUsuario.deleted', { param: this.removeId });
